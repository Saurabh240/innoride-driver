...
class MyStrings {
  //APP Name
  static const String appName = "InnoRide Driver";

  static const String onboardTitle1 = "Drive Your Way to Success"; //Title 1

  static const String onboardDescription1 =
      "Turn your car into a revenue-generating machine & Set your own schedule and earn on your terms. Join our network ";

  static const String onboardTitle2 = "Drive, Earn, Thrive"; //Title 2

  static const String onboardDescription2 =
      "From daily rides to long-distance trips, you choose how you earn. The road to financial independence starts here";

  static const String onboardTitle3 = "Join the Driving Force"; //Title 3

  static const String onboardDescription3 =
      "Become part of a trusted network of drivers. Together, we’re shaping the future of ride-sharing and watch your income grow"; //Des 3
  //Onboard End
  ...
  static const String runningRideMessage =
      'Complete your active ride and start new ride. Before complete running ride you can not start new ride';
  ...
  static const String driverVerificationRequired =
      "Driver Document Verification Required";

  static const String kycVerificationMsg =
      "Please submit the required documents information to verify yourself. Otherwise, you couldn't make any withdrawal request.";

  static const String driverKycPendingMsg =
      "Thank you for submitting your driver documents. Our team is currently reviewing the information.";
  ...
  static const String profileCompleteSubTitle =
      "Profile complete: step into the future";
  ...
  static const String driverDocumentVerification =
  ...
  static const String verifyVehicleAndStartRide =
      "Please verify your vehicle and start ride, earn more ride more";

  static const String waitUntilAdminApprovedYourVerificationRequest =
      "Wait until admin approved your verification request";
  ...
  static const String noReferralDriverFound =
      "Sorry! there are no referral driver found";
  ...
  static const String pleaseReceivePaymentSubtitle =
      "The rider is requesting you to accept the payment";
