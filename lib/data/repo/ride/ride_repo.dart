...
class RideRepo {
  ...
  Future<ResponseModel> getNewRide({required bool isICity}) async {
    String url =
        "${UrlContainer.baseUrl}${UrlContainer.rideList}?ride_type=${isICity ? '2' : '1'}&status=new";
  ...
  Future<ResponseModel> acceptedRide({required bool isICity}) async {
    String url =
        "${UrlContainer.baseUrl}${UrlContainer.rideList}?ride_type=${isICity ? '2' : '1'}&status=accept";
    ResponseModel responseModel =
        await apiClient.request(url, Method.getMethod, null, passHeader: true);
    return responseModel;
  }
  ...
  Future<ResponseModel> activeRide({required bool isICity}) async {
    String url =
        "${UrlContainer.baseUrl}${UrlContainer.rideList}?ride_type=${isICity ? '2' : '1'}&status=2";
    ResponseModel responseModel =
        await apiClient.request(url, Method.getMethod, null, passHeader: true);
    return responseModel;
  }
  ...
  Future<ResponseModel> runningRide({required bool isICity}) async {
    String url =
        "${UrlContainer.baseUrl}${UrlContainer.rideList}?ride_type=${isICity ? '2' : '1'}&status=3";
    ResponseModel responseModel =
        await apiClient.request(url, Method.getMethod, null, passHeader: true);
    return responseModel;
  }

  Future<ResponseModel> getAllRideList(String page,
      {required bool isICity}) async {
    String url =
        "${UrlContainer.baseUrl}${UrlContainer.rideList}?ride_type=${isICity ? '2' : '1'}&status=all&page=$page";
    ResponseModel responseModel =
        await apiClient.request(url, Method.getMethod, null, passHeader: true);
    return responseModel;
  }
  ...
  Future<ResponseModel> acceptCashPayment({
    ...
    String url =
        "${UrlContainer.baseUrl}${UrlContainer.acceptCashPaymentRides}/$id";
  ...
  Future<ResponseModel> canceledRide(String page,
      {required bool isICity}) async {
    String url =
        "${UrlContainer.baseUrl}${UrlContainer.rideList}?ride_type=${isICity ? '2' : '1'}&status=9";
    ResponseModel responseModel =
        await apiClient.request(url, Method.getMethod, null, passHeader: true);
    return responseModel;
  }
  ...
  Future<ResponseModel> createBid(
      {required String rideId, required String amount}) async {
  ...
  Future<ResponseModel> cancelRide({
    ...
    ResponseModel responseModel = await apiClient
        .request(url, Method.getMethod, params, passHeader: true);
    return responseModel;
  }
}
