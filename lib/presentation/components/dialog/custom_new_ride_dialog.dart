  ...
  static newRide({
    ...
    if (Get.context == null) {
      Get.rawSnackbar(
        ...
        messageText: Column(
          children: [
            GestureDetector(
              onTap: () {
                Get.toNamed(RouteHelper.userReviewScreen,
                ...
                rightWidget: Column(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style:
                          boldExtraLarge.copyWith(color: MyColor.primaryColor),
                    ),
                  ],
                ),
                imgWidget: MyImageWidget(
                  imageUrl:
                      '${dashboardController.userImagePath}/${ride.user?.avatar}',
                  boxFit: BoxFit.cover,
                  height: 40,
                  width: 40,
                  radius: 20,
              ...
              child: Center(
                child: Text(
                  MyStrings.recommendPrice.rKv({
                    "priceKey":
                        "$currencySym${StringConverter.formatDouble(ride.recommendAmount.toString())}",
                  ...
                  IntrinsicWidth(
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText:
                            dashboardController.amountController.text.isNotEmpty
                                ? '0'
                                : '0.0',
                      ...
                      press: () {
                        ...
                        if (enterValue < max + 1 && enterValue >= min) {
                          ...
                          CustomSnackBar.error(
                            errorList: [
                              '${MyStrings.pleaseEnterMinimum.tr} ${controller.currencySym}${StringConverter.formatNumber(ride.minAmount ?? '0')} to ${controller.currencySym}${StringConverter.formatNumber(ride.maxAmount ?? '')}'
                            ],
                          );
                        }
                      },
      ...
      Flushbar(
                  ...
                  builder: (controller) => RoundedButton(
                    ...
                    press: () {
                      double enterValue = StringConverter.formatDouble(
                          controller.amountController.text);
                      double min =
                          StringConverter.formatDouble(ride.minAmount ?? '0.0');
                      double max =
                          StringConverter.formatDouble(ride.maxAmount ?? '0.0');
        ...
        duration: Duration(seconds: duration),
        leftBarIndicatorColor: MyColor.primaryColor.withValues(alpha: 0.05),
