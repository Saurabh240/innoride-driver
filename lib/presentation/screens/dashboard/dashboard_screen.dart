...
import 'package:ovoride_driver/data/controller/global_pusher_contorller/global_pusher_controller.dart';
...
import 'package:ovoride_driver/data/controller/running_ride/running_ride_controller.dart';
...
class _DashBoardScreenState extends State<DashBoardScreen> {
  ...
  void initState() {
    ...
    var globalPusherController = Get.put(GlobalPusherController(
        apiClient: Get.find(), dashBoardController: Get.find()));
    //
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      String driverId = apiClient.sharedPreferences
