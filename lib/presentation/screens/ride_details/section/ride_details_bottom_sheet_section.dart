    ...
    return GetBuilder<RideDetailsController>(builder: (controller) {
      ...
      return Container(
        ...
        padding: const EdgeInsets.symmetric(
            horizontal: Dimensions.space10, vertical: Dimensions.space12),
              ...
              if (controller.ride.status == "1") ...[
                if (controller.ride.userReview == null) ...[
                  RoundedButton(
                    ...
                    isOutlined: false,
                    press: () {
                      CustomBottomSheet(child: RideDetailsReviewSection())
                ...
                RoundedButton(
                  ...
                  press: () {
                    AppDialog().showRideDetailsDialog(context,
                        title: MyStrings.pleaseConfirm,
                        description: MyStrings.youWantToEndTheRide, onTap: () {
