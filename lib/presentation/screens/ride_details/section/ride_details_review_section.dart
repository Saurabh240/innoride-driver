      ...
      return Column(
        ...
        children: [
          ...
          Align(
              ...
              child: Text(MyStrings.reviewForUser.tr,
          ...
          Container(
            ...
            child: MyImageWidget(
              ...
              isProfile: true,
              errorWidget:
                  Image.asset(MyImages.defaultAvatar, height: 85, width: 85),
            ),
          ),
          const SizedBox(height: Dimensions.space8),
          Text(
              "${controller.ride.user?.firstname} ${controller.ride.user?.lastname}",
          ...
          Row(
            ...
            children: [
                ...
                children: [
                  ...
                  Text(
                    StringConverter.formatNumber(
                        controller.ride.driver?.avgRating ?? '0.0'),
              ...
              Container(
                  ...
                  decoration: BoxDecoration(
                      border: Border.all(color: MyColor.colorGrey, width: .5))),
              GestureDetector(
                onTap: () =>
                    MyUtils.launchPhone(controller.ride.driver?.mobile),
                child: Row(
                  children: [
                    ...
                    Text("+${controller.ride.driver?.mobile}",
                        style: boldDefault.copyWith(
                            color: MyColor.colorGrey,
                            fontSize: Dimensions.fontDefault,
                            fontWeight: FontWeight.w700)),
          ...
          const CustomDivider(
              space: Dimensions.space10, color: MyColor.bodyText),
          const SizedBox(height: Dimensions.space30),
          Text(MyStrings.ratingUser.tr,
          ...
          Text(MyStrings.whatCouldBetter.tr,
