                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          SizedBox(height: 13),
                          HeaderText(
                              text: controller.repo.apiClient
                                  .getCurrencyOrUsername(
                                      isCurrency: false, isSymbol: false)
                                  .toTitleCase(),
                              textStyle: boldLarge.copyWith(
                                  color: MyColor.titleColor, fontSize: 16)),
                          Row(
                            children: [
                              CustomSvgPicture(
                                  image: MyImages.focus, width: 16, height: 16),
                              SizedBox(width: 5),
                              Expanded(
                                  child: Text(controller.currentAddress,
                      ...
                      (context, index) {
                        return Padding(
                          ...
                          child: NewRideCardWidget(
                            ...
                            currency: controller.currencySym,
                            driverImagePath:
                                '${controller.userImagePath}/${controller.rideList[index].user?.avatar}',
                            press: () {
