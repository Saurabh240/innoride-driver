                  ...
                  child: Center(
                    child: Text(
                      MyStrings.recommendPrice.rKv({
                        "priceKey":
                            "${'\$'}${StringConverter.formatDouble(widget.ride.recommendAmount.toString())}",
                  ...
                  press: () {
                    ...
                    if (enterValue < max + 1 && enterValue >= min) {
                      ...
                      CustomSnackBar.error(
                        errorList: [
                          '${MyStrings.pleaseEnterMinimum.tr} ${controller.currencySym}${StringConverter.formatNumber(widget.ride.minAmount ?? '0')} to ${controller.currencySym}${StringConverter.formatNumber(widget.ride.maxAmount ?? '')}'
                        ],
                      );
                    }
                  },
