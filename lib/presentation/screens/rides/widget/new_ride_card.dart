...
import 'package:ovoride_driver/data/controller/ride/new_ride/new_ride_controller.dart';
              ...
              children: [
                      ...
                      Flexible(
                        child: Text(
                          MyStrings.recommendPrice.rKv({
                            "priceKey":
                                '$currency${StringConverter.formatNumber(ride.recommendAmount ?? '0')}',
                            'distanceKey': '${ride.distance}km'.tr
                          }),
                ...
                RoundedButton(
                 // text: MyStrings.bidNOW,
                  ...
                  isLoading: controller.rideId == ride.id &&
                      controller.isSubmitLoading == true,
                  isColorChange: true,
                  verticalPadding: 15,
