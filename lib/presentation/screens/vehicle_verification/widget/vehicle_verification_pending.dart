...
class VehicleVerificationPendingSection extends StatefulWidget {
  ...
  @override
  State<VehicleVerificationPendingSection> createState() =>
      _VehicleVerificationPendingSectionState();
}

class _VehicleVerificationPendingSectionState
    extends State<VehicleVerificationPendingSection> {
  @override
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        border: Border.all(
                            color: MyColor.naturalLight.withValues(alpha: .4))),
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      ...
                      children: [
                        ...
                        MyImageWidget(
                            imageUrl:
                                "${controller.serviceImagePath}/${controller.selectedService.image ?? ''}",
                            height: 60,
                            width: 60,
                            radius: 10),
                        SizedBox(height: 10),
                        Row(
                          children: [
                            Text("${MyStrings.serviceName} : ",
                                style: mediumDefault),
                            Text(controller.selectedService.name?.tr ?? '',
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        MyImageWidget(
                            imageUrl:
                                "${controller.brandImagePath}/${controller.selectedBrand.image ?? ''}",
                            height: 60,
                            width: 60,
                            radius: 10),
                        SizedBox(height: 10),
                        Row(
                          children: [
                            Text("${MyStrings.brandName.tr} : ",
                                style: mediumDefault),
                            Text(controller.selectedBrand.name?.tr ?? '',
                                style: mediumDefault.copyWith()),
                          ],
                        ),
                        SizedBox(height: 10)
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return controller.pendingData[index].value != null &&
                              controller.pendingData[index].value!.isNotEmpty
                          ? Container(
                              ...
                              child: controller.pendingData[index].type ==
                                      "file"
                                  ? Column(
                                      crossAxisAlignment:
                                      ...
                                      children: [
                                        ...
                                        GestureDetector(
                                          onTap: () {
                                            String url =
                                                "${controller.path}/${controller.pendingData[index].value.toString()}";
                                            printX(url);
                                            showDialog(
                                              context: context,
                                              builder: (context) {
                                  ...
                                  : CardColumn(
                                      header:
                                          controller.pendingData[index].name ??
                                              '',
                                      body: StringConverter
                                          .removeQuotationAndSpecialCharacterFromString(
                                              controller.pendingData[index]
                                                      .value ??
                                                  ''),
